...
namespace SECOM.ACS.WindowsService
{
    ...
    /// </summary>
    internal class AccessControlJobListener : IJobListener
    {
        ...
        /// <summary>
        /// Initialises a new instance of the AccessControlJobListener class.
        /// </summary>
        /// <param name="provider">Container provider instance.</param>
        public AccessControlJobListener(IContainerProvider provider)
        {
            if (provider == null)
                throw new ArgumentNullException("provider");

            this._provider = provider;
            this.Name = "AccessControlJobListener";
        }
