...
namespace SECOM.ACS.WindowsService
{
    ...
    /// </summary>
    internal class AccessControlJobFactory : IJobFactory
    {
        private readonly IContainer _container;

        /// <summary>
        /// Initialises a new instance of the AccessControlJobFactory class.
        /// </summary>
        /// <param name="container">IoC container instance.</param>
        public AccessControlJobFactory(IContainer container)
        {
            if (container == null)
